...
//	    console.log = function() {}
        ...
        var select = function(s) {
            ...
            headlineMarker = select('.headline-marker'),
...
/******************  MAIN ANIMATION  ******************/
		function animate() {
            ...
            // frame1
            .from([logo, cta], {duration:0.9, y:gsap.utils.wrap(["-=50", "+=50"]), ease:"back.In"}, "<0.5")
            // .from(cta, {duration:0.9, y:"+=170", ease:"back.In"}, "<0.5")
            // .from([text1, text2], {duration:1, y:gsap.utils.wrap(["-=50", "+=50"]), alpha:0, ease:"sine"}, "<1.3")
            .from(splitTextTop.chars, {duration:0.7, stagger:0.03, x:"+=20", alpha:0, ease:"power3"}, "<0.5")
            .from(headlines[0], {duration:0.9, y:"+=120"}, "<0.5")
            .to(headlineMarker, {duration: 6, color:"#ff9800", scale:2, stagger: 0.1}, "<0.9")
